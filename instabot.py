...
APP_ACCESS_TOKEN = '3062742211.dc8e65d.621580c1b44c4502a137f2bf4b436282'
...
def start_bot():
    while True:
        print '\n'
        print colored('Hello! ---Welcome to InstaBot,You will get an osm experience by using it---!','blue')
        print colored('Menu options are:','green')
        ...
        print colored("e.Get a list of people who have liked the recent post of a user by username\n",'cyan')
        ...
        print colored("j.Get post by perticular caption",'cyan')
        print colored("k.Exit", 'cyan')
